...
<nav x-data="{ open: false }" style="background-color: rgba(14, 29, 52, 0.9);"
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a style="font-size: 32px" class="text-light" href="{{ route('dashboard') }}">
                        CMS
                    </a>
                </div>
            </div>
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li>
                        ...
                        <a href="#exampleModal" data-mdb-toggle="modal" data-mdb-target="#exampleModal">
                            + Compose
                        </a>
                    </li>
                    </li>
